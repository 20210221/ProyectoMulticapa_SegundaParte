...
namespace Capa_Presentacion
{
    public partial class Form_Presentacion : Form
    {
        ...
        public void EditTable()
        {
            ...
            TablaContactos.Columns[1].Width = 230;

            TablaContactos.Columns[2].Width = 230;

            TablaContactos.Columns[3].Width = 200;
        ...
        {
            MessageBox.Show("Esta Opcion Solo Es Decorativa", "Función No Disponible");
        }
